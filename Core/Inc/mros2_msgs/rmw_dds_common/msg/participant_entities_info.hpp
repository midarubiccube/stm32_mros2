...
#include "mros2_msgs/rmw_dds_common/msg/node_entities_info.hpp"
...
namespace rmw_dds_common
{
  namespace msg
  {
    ...
    public:
      ...
      template <class T>
      uint32_t copyPrimToFragBufLocal(uint8_t *&addrPtr,  const uint32_t cntPub, const uint32_t size, const T &data)
      {
      ...
      template <class T>
      FragCopyReturnType copyArrayToFragBufLocal(uint8_t *&addrPtr,const uint32_t size, T &data,uint32_t &cntPubMemberLocal)
      {
