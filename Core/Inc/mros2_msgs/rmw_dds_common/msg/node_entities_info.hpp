...
public:
  ...
  std::vector<rmw_dds_common::msg::Gid> reader_gid_seq;
  
  std::vector<rmw_dds_common::msg::Gid> writer_gid_seq;
...
private:
  std::string type_name = "rmw_dds_common::msg::dds_::NodeEntitiesInfo";
};
};
}
